...
@include('web.includes.head')
  ...
  <!-- ======= Hero Section ======= -->
  <section style="background: url({{ $hero->image }}) top right no-repeat;" id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>{{ $hero -> name }}</h1>
      <p>I'm <span class="typed" data-typed-items="{{ $hero -> role }}"></span></p>
